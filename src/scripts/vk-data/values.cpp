...
CGET_DEF(std::string,MSG_YOU_INFLICTED_BONUS_INNATE_SNIPER_RIFLE_ATTACK,"{grn}*** Your expertly deal bonus damage ***{/grn}");
...
CGET_DEF(uint8_t,WEAPON_COOLDOWN_TICK_REMOVAL_TIER_ONE_MAX,6);
CGET_DEF(uint8_t,WEAPON_COOLDOWN_TICK_REMOVAL_TIER_TWO_MAX,9);
CGET_DEF(uint8_t,WEAPON_COOLDOWN_TICK_REMOVAL_TIER_THREE_MAX,12);
...
CGET_DEF(uint8_t,TERRIBLE_SKILL_CHANCE_OF_SUCCESS,80);
CGET_DEF(uint8_t,AWFUL_SKILL_CHANCE_OF_SUCCESS,90);
CGET_DEF(uint8_t,OKAY_SKILL_CHANCE_OF_SUCCESS,98);
CGET_DEF(uint8_t,LEARNED_SKILL_CHANCE_OF_SUCCESS,100);
