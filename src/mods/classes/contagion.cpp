...
namespace mods::classes {
	...
	void contagion::init() {
		...
		m_abilities = create_abilities({
			{PATHOGEN_AMMUNITION,"patho","Pathogen Ammunition",skillset_t::INTELLIGENCE,&m_pathogen_ammunition,0},
			{GRIM_AURA,"aura","Grim Aura",skillset_t::INTELLIGENCE,&m_grim_aura,0},
			{MELT,"melt","Melt",skillset_t::INTELLIGENCE,&m_melt,0},
			{SUFFOCATE,"suff","Suffocate",skillset_t::INTELLIGENCE,&m_suffocate,0},
			{SHREDDED_CANTRIP,"shred","Shredded Cantrip",skillset_t::INTELLIGENCE,&m_shredded_cantrip,0},
			{MUSCLE_MEMORY,"mm","Muscle Memory",skillset_t::INTELLIGENCE,&m_muscle_memory,0},
			{HELLFIRE_CIRCLE,"hfc","Hellfire Circle",skillset_t::INTELLIGENCE,&m_hellfire_circle,0},
			{PARTICLE_DECELERATION,"pardec","Particle Deceleration",skillset_t::INTELLIGENCE,&m_particle_deceleration,0},
			{GHASTLY_DOUBLE,"gd","Ghastly Double",skillset_t::INTELLIGENCE,&m_ghastly_double,0},
			{MINOR_SHIELDING,"ms","Minor Shielding",skillset_t::INTELLIGENCE,&m_minor_shielding,0},
			{CURSED_BALLISTICS,"curb","Cursed Ballistics",skillset_t::INTELLIGENCE,&m_cursed_ballistics,0},
			{NEUTRON_SHIELD,"ns","Neutron Shield",skillset_t::INTELLIGENCE,&m_neutron_shield,0},
			{BLADED_ARRAY,"ba","Bladed Array",skillset_t::INTELLIGENCE,&m_bladed_array,0},
			{ROOTS_OF_MAYHEM,"rom","Roots of Mayhem",skillset_t::INTELLIGENCE,&m_roots_of_mayhem,0},
			{MORBID_DOUBT,"mord","Morbid Doubt",skillset_t::INTELLIGENCE,&m_morbid_doubt,0},
			{INTIMIDATE,"int","Intimidate",skillset_t::INTELLIGENCE,&m_intimidate,0},
			{FORCE_OUT,"force","Force Out",skillset_t::INTELLIGENCE,&m_force_out,0},
			{LEECH,"leech","Leech",skillset_t::INTELLIGENCE,&m_leech,0},
			{PARASITIC_CORPSE_TAP,"pctap","Parasitic Corpse Tap",skillset_t::INTELLIGENCE,&m_parasitic_corpse_tap,0},
			{EXTRACT_ORGANS,"extr","Extract Organs",skillset_t::INTELLIGENCE,&m_extract_organs,0},
			{RECRUIT,"rec","Recruit",skillset_t::INTELLIGENCE,&m_recruit,0},
			{DEMONIC_INCANTATION,"demi","Demonic Incantation",skillset_t::INTELLIGENCE,&m_demonic_incantation,0},
			{SHADOW_SIGHT,"ss","Shadow Sight",skillset_t::INTELLIGENCE,&m_shadow_sight,0},
			{MORBID_INSIGHT,"mi","Morbid Insight",skillset_t::INTELLIGENCE,&m_morbid_insight,0},
			{LIFE_TAP,"tap","Life Tap",skillset_t::INTELLIGENCE,&m_life_tap,0},
			{CORPSE_EXPLOSION,"ce","Corpse Explosion",skillset_t::DEMOLITIONS,&m_corpse_explosion,0},
			{SHRAPNEL_CORPSE_EXPLOSION,"sce","Shrapnel Corpse Explosion",skillset_t::DEMOLITIONS,&m_shrapnel_corpse_explosion,0},
			{CORROSIVE_CORPSE_EXPLOSION,"cce","Corrosive Corpse Explosion",skillset_t::DEMOLITIONS,&m_corrosive_corpse_explosion,0},
