...
case vk_LEVELS_FIRST_TIER: return "LEVELS_FIRST_TIER";
...
case vk_MSG_HIT_BY_INCENDIARY_MELEE_ATTACK: return "MSG_HIT_BY_INCENDIARY_MELEE_ATTACK";
case vk_MSG_HIT_BY_RADIOACTIVE_MELEE_ATTACK: return "MSG_HIT_BY_RADIOACTIVE_MELEE_ATTACK";
case vk_MSG_HIT_BY_ANTI_MATTER_MELEE_ATTACK: return "MSG_HIT_BY_ANTI_MATTER_MELEE_ATTACK";
case vk_MSG_HIT_BY_CORROSIVE_MELEE_ATTACK: return "MSG_HIT_BY_CORROSIVE_MELEE_ATTACK";
case vk_MSG_HIT_BY_EMP_MELEE_ATTACK: return "MSG_HIT_BY_EMP_MELEE_ATTACK";
case vk_MSG_HIT_BY_EXPLOSIVE_MELEE_ATTACK: return "MSG_HIT_BY_EXPLOSIVE_MELEE_ATTACK";
case vk_MSG_HIT_BY_SHRAPNEL_MELEE_ATTACK: return "MSG_HIT_BY_SHRAPNEL_MELEE_ATTACK";
case vk_MSG_HIT_BY_CRYOGENIC_MELEE_ATTACK: return "MSG_HIT_BY_CRYOGENIC_MELEE_ATTACK";
case vk_MSG_HIT_BY_SHOCK_MELEE_ATTACK: return "MSG_HIT_BY_SHOCK_MELEE_ATTACK";
...
if(!s.compare("LEVELS_FIRST_TIER")){ return vk_LEVELS_FIRST_TIER;}
...
if(!s.compare("MSG_HIT_BY_INCENDIARY_MELEE_ATTACK")){ return vk_MSG_HIT_BY_INCENDIARY_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_RADIOACTIVE_MELEE_ATTACK")){ return vk_MSG_HIT_BY_RADIOACTIVE_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_ANTI_MATTER_MELEE_ATTACK")){ return vk_MSG_HIT_BY_ANTI_MATTER_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_CORROSIVE_MELEE_ATTACK")){ return vk_MSG_HIT_BY_CORROSIVE_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_EMP_MELEE_ATTACK")){ return vk_MSG_HIT_BY_EMP_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_EXPLOSIVE_MELEE_ATTACK")){ return vk_MSG_HIT_BY_EXPLOSIVE_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_SHRAPNEL_MELEE_ATTACK")){ return vk_MSG_HIT_BY_SHRAPNEL_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_CRYOGENIC_MELEE_ATTACK")){ return vk_MSG_HIT_BY_CRYOGENIC_MELEE_ATTACK;}
if(!s.compare("MSG_HIT_BY_SHOCK_MELEE_ATTACK")){ return vk_MSG_HIT_BY_SHOCK_MELEE_ATTACK;}
...
CGET_DEF(std::string,MSG_HIT_BY_INCENDIARY_MELEE_ATTACK,"{red}*** YOU TAKE {yel}INCENDIARY{/yel}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_RADIOACTIVE_MELEE_ATTACK,"{red}*** YOU TAKE {grn}RADIOACTIVE{/blu}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_ANTI_MATTER_MELEE_ATTACK,"{red}*** YOU TAKE {blu}ANTI-MATTER{/blu}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_CORROSIVE_MELEE_ATTACK,"{red}*** YOU TAKE {grn}CORROSIVE{/grn}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_EMP_MELEE_ATTACK,"{red}*** YOU TAKE {blu}EMP{/blu}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_EXPLOSIVE_MELEE_ATTACK,"{red}*** YOU TAKE {yel}EXPLOSIVE{/yel}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_SHRAPNEL_MELEE_ATTACK,"{red}*** YOU TAKE {blu}SHRAPNEL{/blu}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_CRYOGENIC_MELEE_ATTACK,"{red}*** YOU TAKE {blu}CRYOGENIC{/blu}{red} MELEE DAMAGE ***{/red} -- ");
CGET_DEF(std::string,MSG_HIT_BY_SHOCK_MELEE_ATTACK,"{red}*** YOU TAKE {blu}SHOCK{/blu}{red} MELEE DAMAGE ***{/red} -- ");
