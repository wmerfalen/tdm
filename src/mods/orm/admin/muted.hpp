#ifndef __MENTOC_MODS_ORM_ADMIN_MUTED_HEADER__
#define __MENTOC_MODS_ORM_ADMIN_MUTED_HEADER__
...
namespace mods::orm::admin {
	 ...
	 * will - 2020-09-28
	 */
	struct muted : public mods::orm::orm_base<muted,std::string> {
		...
		void load_all();
		auto create_game(mods::muteds::muted_payload_t game) {
			return this->create<muted>(this);
		}
		auto update_game(uint64_t pk_id,mods::muteds::muted_payload_t game) {
			return this->update<muted>(this);
		}
