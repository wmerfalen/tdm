...
#define CGET(A,KEY) \
		...
		CGET(std::string,CHARGEN_GHOST_CLASS_DESCRIPTION);
			...
			CGET(std::string,CHARGEN_GHOST_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_MARKSMAN_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_BANDIT_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_BUTCHER_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_STRIKER_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_OBSTRUCTOR_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_MALADY_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_PYREXIA_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_DEALER_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_FORGE_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_SYNDROME_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_MACHINIST_CLASS_TRIADS);
		 	CGET(std::string,CHARGEN_UNDEFINED_CLASS_TRIADS);
