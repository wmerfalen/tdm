...
#define HELP_STR static constexpr const char*
	HELP_STR h_combat=
	    "{grn}|---[ TOPIC: Combat ]-------------------------------------------------------------|{/grn}\r\n"
	    "{grn}|   ----------------------                                                        |{/grn}\r\n"
	    "{grn}|  | Rules of engagement |                                                        |{/grn}\r\n"
	    "{grn}|  |---------------------|--------------------------------------------------------|{/grn}\r\n"
	    "{grn}|  | There are different ranges of combat in TD.                                  |{/grn}\r\n"
	    "{grn}|  | {blu}1) Ranged combat{/blu}                                                             {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}2) Close quarters combat{/blu}                                                     {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | When you use the 'snipe' command and hit a target that is a few rooms away   |{/grn}\r\n"
	    "{grn}|  | from you, you are engaging in ranged combat. You are free to move around and |{/grn}\r\n"
	    "{grn}|  | do not need to flee from combat. As long as your target doesn't walk into    |{/grn}\r\n"
	    "{grn}|  | the room you reside in and subsequently attack you, you are safe to move     |{/grn}\r\n"
	    "{grn}|  | around freely.                                                               |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | However, if you choose to go into the same room as your target, or if your   |{/grn}\r\n"
	    "{grn}|  | target moves to your room, you are now in Close Quarters Combat range.       |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | When you are engaged in CQC, the dynamics of battle change. If you are       |{/grn}\r\n"
	    "{grn}|  | wielding a Sniper rifle, you will not be able to hit your target as sniper   |{/grn}\r\n"
	    "{grn}|  | rifles only work on targets that are not in the same room as you.            |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | Now if you were to use any other type of ranged weapon like an A.R., or a    |{/grn}\r\n"
	    "{grn}|  | sub-machine gun, you could continue doing battle with your target even if    |{/grn}\r\n"
	    "{grn}|  | they are in the same room as you.                                            |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | There some exceptions to this rule. Mainly, if you have an underbarrel       |{/grn}\r\n"
	    "{grn}|  | attachment like a shotgun underbarrel attached to your sniper rifle.         |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | If you are wielding a weapoon in your SECONDARY position, you would be able  |{/grn}\r\n"
	    "{grn}|  | use that weapon in CQC range. All weapons that can be wielded in the         |{/grn}\r\n"
	    "{grn}|  | SECONDARY position can seemlessly deal damage to targets in the CQC range.   |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | But sometimes you want more control over how you react to a target that goes |{/grn}\r\n"
	    "{grn}|  | from RANGED comat to CQC combat. This is where Rules of Engagement come into |{/grn}\r\n"
	    "{grn}|  | play.                                                                        |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | Rules of engagement allow you to dictate how you respond to an enemy closing |{/grn}\r\n"
	    "{grn}|  | the distance on you. There are different types of rules of engagement        |{/grn}\r\n"
	    "{grn}|  | available to you:                                                            |{/grn}\r\n"
	    "{grn}|  |                                                                              |{/grn}\r\n"
	    "{grn}|  | {blu}1) Ballistic{/blu}                                                                 {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}2) CQC{/blu}                                                                       {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}3) Auxiliary{/blu}                                                                 {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}4) Secondary{/blu}                                                                 {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}Ballistic{/blu}                                                                    {grn}|{/grn}\r\n"
	    "{grn}|  | When your rules of engagement are set to Ballistic, when a target closes the {grn}|{/grn}\r\n"
	    "{grn}|  | distance and appears in your room, you will continune to use your primary    {grn}|{/grn}\r\n"
	    "{grn}|  | weapon as long as your primary is not a sniper rifle                         {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}CQC{/blu}                                                                          {grn}|{/grn}\r\n"
	    "{grn}|  | When your rules of engagement are set to CQC, when a target closes the       {grn}|{/grn}\r\n"
	    "{grn}|  | distance and appears in your room, you will use hand to hand combat.         {grn}|{/grn}\r\n"
	    "{grn}|  | If you have set a combat order (see the helpfile for combat_ordere), you will{grn}|{/grn}\r\n"
	    "{grn}|  | proceed to throw the maneuvers you specified.                                {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}Auxiliary{/blu}                                                                    {grn}|{/grn}\r\n"
	    "{grn}|  | When your rules of engagement are set to Auxiliary, when a target closes the {grn}|{/grn}\r\n"
	    "{grn}|  | distance and appears in your room, you will use the underbarrel attachment   {grn}|{/grn}\r\n"
	    "{grn}|  | on your primary weapon to engage your target. This will work as long as your {grn}|{/grn}\r\n"
	    "{grn}|  | attachment has ammunition.                                                   {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  | {blu}Secondary{/blu}                                                                    {grn}|{/grn}\r\n"
	    "{grn}|  | When your rules of engagement are set to Secondary, when a target closes the {grn}|{/grn}\r\n"
	    "{grn}|  | distance and appears in your room, you will use the weapon in your secondary {grn}|{/grn}\r\n"
	    "{grn}|  | position.                                                                    {grn}|{/grn}\r\n"
	    "{grn}|  |                                                                              {grn}|{/grn}\r\n"
	    "{grn}|  |------------------------------------------------------------------------------|{/grn}\r\n"
	    ;
	HELP_STR h_practice=
...
#define M_MATCH(A,SUBJECT) if(matches_many(A,topic)){ player->sendln(CAT(pages::SUBJECT)); return false; }
		M_MATCH("combat,roe,rules_of_engagement,cqc,sniping,kill,engage",h_combat);
