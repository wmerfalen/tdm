#ifndef __MENTOC_MODS_ARMOR_ADVANCED_PROTECTION_HEADER__
#define  __MENTOC_MODS_ARMOR_ADVANCED_PROTECTION_HEADER__
...
namespace mods::armor {
	struct advanced_protection {
		advanced_protection() = delete;
		~advanced_protection() = default;
		void init();
		advanced_protection(uuid_t player);
