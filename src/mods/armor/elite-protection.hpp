#ifndef __MENTOC_MODS_ARMOR_ELITE_PROTECTION_HEADER__
#define  __MENTOC_MODS_ARMOR_ELITE_PROTECTION_HEADER__
...
namespace mods::armor {
	struct elite_protection {
		elite_protection() = delete;
		~elite_protection() = default;
		void init();
		elite_protection(uuid_t player);
