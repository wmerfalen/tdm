...
#define MENTOC_ATTACHMENT_MEMBERS_TUPLE ( \
    ...
    (int16_t,dice_sides,"#int16_t,can be used to determine effectiveness or base damage",0), \
    (int16_t,dice_count,"#int16_t,can be used to determine effectiveness or base damage",0), \
