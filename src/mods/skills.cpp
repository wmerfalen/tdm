...
namespace mods::skills {
	...
	void refresh_minimum_proficiencies() {
		...
		e_name_to_proficiency[just_proficiency_name_t::GRENADE_USAGE].minimum_proficiency = SKILL_GRENADE_USAGE();/** 50 */
		e_name_to_proficiency[just_proficiency_name_t::CLAYMORE_USAGE].minimum_proficiency = SKILL_CLAYMORE_USAGE();/** 50 */
		e_name_to_proficiency[just_proficiency_name_t::BREACH_USAGE].minimum_proficiency = SKILL_BREACH_USAGE();/** 50 */
		tier_one_proficiencies.emplace_back(p::GRENADE_USAGE);
		tier_one_proficiencies.emplace_back(p::CLAYMORE_USAGE);
		tier_one_proficiencies.emplace_back(p::BREACH_USAGE);
