...
namespace mods {
	namespace js {
		...
		static duk_ret_t modify_plr_flags(duk_context *ctx) {
			...
			if(key.compare("KILLER")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_KILLER);
				} else {
					player_ptr->remove_affect_plr(PLR_KILLER);
				}
			} else if(key.compare("THIEF")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_THIEF);
				} else {
					player_ptr->remove_affect_plr(PLR_THIEF);
				}
			} else if(key.compare("FROZEN")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_FROZEN);
				} else {
					player_ptr->remove_affect_plr(PLR_FROZEN);
				}
			} else if(key.compare("DONTSET")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_DONTSET);
				} else {
					player_ptr->remove_affect_plr(PLR_DONTSET);
				}
			} else if(key.compare("WRITING")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_WRITING);
				} else {
					player_ptr->remove_affect_plr(PLR_WRITING);
				}
			} else if(key.compare("MAILING")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_MAILING);
				} else {
					player_ptr->remove_affect_plr(PLR_MAILING);
				}
			} else if(key.compare("CRASH")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_CRASH);
				} else {
					player_ptr->remove_affect_plr(PLR_CRASH);
				}
			} else if(key.compare("SITEOK")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_SITEOK);
				} else {
					player_ptr->remove_affect_plr(PLR_SITEOK);
				}
			} else if(key.compare("NOSHOUT")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_NOSHOUT);
				} else {
					player_ptr->remove_affect_plr(PLR_NOSHOUT);
				}
			} else if(key.compare("NOTITLE")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_NOTITLE);
				} else {
					player_ptr->remove_affect_plr(PLR_NOTITLE);
				}
			} else if(key.compare("DELETED")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_DELETED);
				} else {
					player_ptr->remove_affect_plr(PLR_DELETED);
				}
			} else if(key.compare("LOADROOM")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_LOADROOM);
				} else {
					player_ptr->remove_affect_plr(PLR_LOADROOM);
				}
			} else if(key.compare("NOWIZLIST")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_NOWIZLIST);
				} else {
					player_ptr->remove_affect_plr(PLR_NOWIZLIST);
				}
			} else if(key.compare("NODELETE")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_NODELETE);
				} else {
					player_ptr->remove_affect_plr(PLR_NODELETE);
				}
			} else if(key.compare("INVSTART")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_INVSTART);
				} else {
					player_ptr->remove_affect_plr(PLR_INVSTART);
				}
			} else if(key.compare("CRYO")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_CRYO);
				} else {
					player_ptr->remove_affect_plr(PLR_CRYO);
				}
			} else if(key.compare("NOTDEADYET")==0) {
				if(on) {
					player_ptr->affect_plr(PLR_NOTDEADYET);
				} else {
					player_ptr->remove_affect_plr(PLR_NOTDEADYET);
				}
			}
			duk_push_number(ctx,0);
			return 1;
		...
		static duk_ret_t modify_affected_flags(duk_context *ctx) {
			...
			if(key.compare("BLIND") == 0) {
				if(on) {
					player_ptr->affect(AFF_BLIND);
				} else {
					player_ptr->remove_affect(AFF_BLIND);
				}
			} else if(key.compare("INVISIBLE") == 0) {
				if(on) {
					player_ptr->affect(AFF_INVISIBLE);
				} else {
					player_ptr->remove_affect(AFF_INVISIBLE);
				}
			} else if(key.compare("DETECT_ALIGN") == 0) {
				if(on) {
					player_ptr->affect(AFF_DETECT_ALIGN);
				} else {
					player_ptr->remove_affect(AFF_DETECT_ALIGN);
				}
			} else if(key.compare("DETECT_INVIS") == 0) {
				if(on) {
					player_ptr->affect(AFF_DETECT_INVIS);
				} else {
					player_ptr->remove_affect(AFF_DETECT_INVIS);
				}
			} else if(key.compare("DETECT_MAGIC") == 0) {
				if(on) {
					player_ptr->affect(AFF_DETECT_MAGIC);
				} else {
					player_ptr->remove_affect(AFF_DETECT_MAGIC);
				}
			} else if(key.compare("SENSE_LIFE") == 0) {
				if(on) {
					player_ptr->affect(AFF_SENSE_LIFE);
				} else {
					player_ptr->remove_affect(AFF_SENSE_LIFE);
				}
			} else if(key.compare("INTIMIDATED") == 0) {
				if(on) {
					player_ptr->affect(AFF_INTIMIDATED);
				} else {
					player_ptr->remove_affect(AFF_INTIMIDATED);
				}
			} else if(key.compare("SANCTUARY") == 0) {
				if(on) {
					player_ptr->affect(AFF_SANCTUARY);
				} else {
					player_ptr->remove_affect(AFF_SANCTUARY);
				}
			} else if(key.compare("GROUP") == 0) {
				if(on) {
					player_ptr->affect(AFF_GROUP);
				} else {
					player_ptr->remove_affect(AFF_GROUP);
				}
			} else if(key.compare("CURSE") == 0) {
				if(on) {
					player_ptr->affect(AFF_CURSE);
				} else {
					player_ptr->remove_affect(AFF_CURSE);
				}
			} else if(key.compare("INFRAVISION") == 0) {
				if(on) {
					player_ptr->affect(AFF_INFRAVISION);
				} else {
					player_ptr->remove_affect(AFF_INFRAVISION);
				}
			} else if(key.compare("POISON") == 0) {
				if(on) {
					player_ptr->affect(AFF_POISON);
				} else {
					player_ptr->remove_affect(AFF_POISON);
				}
			} else if(key.compare("PROTECT_EVIL") == 0) {
				if(on) {
					player_ptr->affect(AFF_PROTECT_EVIL);
				} else {
					player_ptr->remove_affect(AFF_PROTECT_EVIL);
				}
			} else if(key.compare("PROTECT_GOOD") == 0) {
				if(on) {
					player_ptr->affect(AFF_PROTECT_GOOD);
				} else {
					player_ptr->remove_affect(AFF_PROTECT_GOOD);
				}
			} else if(key.compare("SLEEP") == 0) {
				if(on) {
					player_ptr->affect(AFF_SLEEP);
				} else {
					player_ptr->remove_affect(AFF_SLEEP);
				}
			} else if(key.compare("NOTRACK") == 0) {
				if(on) {
					player_ptr->affect(AFF_NOTRACK);
				} else {
					player_ptr->remove_affect(AFF_NOTRACK);
				}
			} else if(key.compare("UNUSED16") == 0) {
				if(on) {
					player_ptr->affect(AFF_UNUSED16);
				} else {
					player_ptr->remove_affect(AFF_UNUSED16);
				}
			} else if(key.compare("UNUSED17") == 0) {
				if(on) {
					player_ptr->affect(AFF_UNUSED17);
				} else {
					player_ptr->remove_affect(AFF_UNUSED17);
				}
			} else if(key.compare("SNEAK") == 0) {
				if(on) {
					player_ptr->affect(AFF_SNEAK);
				} else {
					player_ptr->remove_affect(AFF_SNEAK);
				}
			} else if(key.compare("HIDE") == 0) {
				if(on) {
					player_ptr->affect(AFF_HIDE);
				} else {
					player_ptr->remove_affect(AFF_HIDE);
				}
			} else if(key.compare("UNUSED20") == 0) {
				if(on) {
					player_ptr->affect(AFF_UNUSED20);
				} else {
					player_ptr->remove_affect(AFF_UNUSED20);
				}
			} else if(key.compare("CHARM") == 0) {
				if(on) {
					player_ptr->affect(AFF_CHARM);
				} else {
					player_ptr->remove_affect(AFF_CHARM);
				}
			}
			duk_push_number(ctx,0);
			return 1;
		...
		static duk_ret_t affect_from_char(duk_context *ctx) {
			...
			if(key.compare("ANIMATE_DEAD") == 0) {
				::affect_from_char(*player_ptr,SPELL_ANIMATE_DEAD);
			}
			if(key.compare("ARMOR") == 0) {
				::affect_from_char(*player_ptr,SPELL_ARMOR);
			}
			if(key.compare("BLESS") == 0) {
				::affect_from_char(*player_ptr,SPELL_BLESS);
			}
			if(key.compare("BLINDNESS") == 0) {
				::affect_from_char(*player_ptr,SPELL_BLINDNESS);
			}
			if(key.compare("BURNING_HANDS") == 0) {
				::affect_from_char(*player_ptr,SPELL_BURNING_HANDS);
			}
			if(key.compare("CALL_LIGHTNING") == 0) {
				::affect_from_char(*player_ptr,SPELL_CALL_LIGHTNING);
			}
			if(key.compare("CHARM") == 0) {
				::affect_from_char(*player_ptr,SPELL_CHARM);
			}
			if(key.compare("CHILL_TOUCH") == 0) {
				::affect_from_char(*player_ptr,SPELL_CHILL_TOUCH);
			}
			if(key.compare("CLONE") == 0) {
				::affect_from_char(*player_ptr,SPELL_CLONE);
			}
			if(key.compare("COLOR_SPRAY") == 0) {
				::affect_from_char(*player_ptr,SPELL_COLOR_SPRAY);
			}
			if(key.compare("CONTROL_WEATHER") == 0) {
				::affect_from_char(*player_ptr,SPELL_CONTROL_WEATHER);
			}
			if(key.compare("CREATE_FOOD") == 0) {
				::affect_from_char(*player_ptr,SPELL_CREATE_FOOD);
			}
			if(key.compare("CREATE_WATER") == 0) {
				::affect_from_char(*player_ptr,SPELL_CREATE_WATER);
			}
			if(key.compare("CURE_BLIND") == 0) {
				::affect_from_char(*player_ptr,SPELL_CURE_BLIND);
			}
			if(key.compare("CURE_CRITIC") == 0) {
				::affect_from_char(*player_ptr,SPELL_CURE_CRITIC);
			}
			if(key.compare("CURE_LIGHT") == 0) {
				::affect_from_char(*player_ptr,SPELL_CURE_LIGHT);
			}
			if(key.compare("CURSE") == 0) {
				::affect_from_char(*player_ptr,SPELL_CURSE);
			}
			if(key.compare("DETECT_ALIGN") == 0) {
				::affect_from_char(*player_ptr,SPELL_DETECT_ALIGN);
			}
			if(key.compare("DETECT_INVIS") == 0) {
				::affect_from_char(*player_ptr,SPELL_DETECT_INVIS);
			}
			if(key.compare("DETECT_MAGIC") == 0) {
				::affect_from_char(*player_ptr,SPELL_DETECT_MAGIC);
			}
			if(key.compare("DETECT_POISON") == 0) {
				::affect_from_char(*player_ptr,SPELL_DETECT_POISON);
			}
			if(key.compare("DISPEL_EVIL") == 0) {
				::affect_from_char(*player_ptr,SPELL_DISPEL_EVIL);
			}
			if(key.compare("DISPEL_GOOD") == 0) {
				::affect_from_char(*player_ptr,SPELL_DISPEL_GOOD);
			}
			if(key.compare("EARTHQUAKE") == 0) {
				::affect_from_char(*player_ptr,SPELL_EARTHQUAKE);
			}
			if(key.compare("ENCHANT_WEAPON") == 0) {
				::affect_from_char(*player_ptr,SPELL_ENCHANT_WEAPON);
			}
			if(key.compare("ENERGY_DRAIN") == 0) {
				::affect_from_char(*player_ptr,SPELL_ENERGY_DRAIN);
			}
			if(key.compare("FIREBALL") == 0) {
				::affect_from_char(*player_ptr,SPELL_FIREBALL);
			}
			if(key.compare("GROUP_ARMOR") == 0) {
				::affect_from_char(*player_ptr,SPELL_GROUP_ARMOR);
			}
			if(key.compare("GROUP_HEAL") == 0) {
				::affect_from_char(*player_ptr,SPELL_GROUP_HEAL);
			}
			if(key.compare("GROUP_RECALL") == 0) {
				::affect_from_char(*player_ptr,SPELL_GROUP_RECALL);
			}
			if(key.compare("HARM") == 0) {
				::affect_from_char(*player_ptr,SPELL_HARM);
			}
			if(key.compare("HEAL") == 0) {
				::affect_from_char(*player_ptr,SPELL_HEAL);
			}
			if(key.compare("INFRAVISION") == 0) {
				::affect_from_char(*player_ptr,SPELL_INFRAVISION);
			}
			if(key.compare("INTIMIDATED") == 0) {
				::affect_from_char(*player_ptr,SPELL_INTIMIDATED);
			}
			if(key.compare("INVISIBLE") == 0) {
				::affect_from_char(*player_ptr,SPELL_INVISIBLE);
			}
			if(key.compare("LIGHTNING_BOLT") == 0) {
				::affect_from_char(*player_ptr,SPELL_LIGHTNING_BOLT);
			}
			if(key.compare("LOCATE_OBJECT") == 0) {
				::affect_from_char(*player_ptr,SPELL_LOCATE_OBJECT);
			}
			if(key.compare("MAGIC_MISSILE") == 0) {
				::affect_from_char(*player_ptr,SPELL_MAGIC_MISSILE);
			}
			if(key.compare("POISON") == 0) {
				::affect_from_char(*player_ptr,SPELL_POISON);
			}
			if(key.compare("PROT_FROM_EVIL") == 0) {
				::affect_from_char(*player_ptr,SPELL_PROT_FROM_EVIL);
			}
			if(key.compare("REMOVE_CURSE") == 0) {
				::affect_from_char(*player_ptr,SPELL_REMOVE_CURSE);
			}
			if(key.compare("REMOVE_POISON") == 0) {
				::affect_from_char(*player_ptr,SPELL_REMOVE_POISON);
			}
			if(key.compare("SANCTUARY") == 0) {
				::affect_from_char(*player_ptr,SPELL_SANCTUARY);
			}
			if(key.compare("SENSE_LIFE") == 0) {
				::affect_from_char(*player_ptr,SPELL_SENSE_LIFE);
			}
			if(key.compare("SHOCKING_GRASP") == 0) {
				::affect_from_char(*player_ptr,SPELL_SHOCKING_GRASP);
			}
			if(key.compare("SLEEP") == 0) {
				::affect_from_char(*player_ptr,SPELL_SLEEP);
			}
			if(key.compare("STRENGTH") == 0) {
				::affect_from_char(*player_ptr,SPELL_STRENGTH);
			}
			if(key.compare("SUMMON") == 0) {
				::affect_from_char(*player_ptr,SPELL_SUMMON);
			}
			if(key.compare("TELEPORT") == 0) {
				::affect_from_char(*player_ptr,SPELL_TELEPORT);
			}
			if(key.compare("VENTRILOQUATE") == 0) {
				::affect_from_char(*player_ptr,SPELL_VENTRILOQUATE);
			}
			if(key.compare("WORD_OF_RECALL") == 0) {
				::affect_from_char(*player_ptr,SPELL_WORD_OF_RECALL);
			}
			duk_push_number(ctx,0);
			return 1;
		}
		...
		static duk_ret_t set_points(duk_context *ctx) {
			...
			if(key.compare("mana") == 0) {
				player_ptr->mana() = static_cast<sh_int>(value);
			} else if(key.compare("max_mana") == 0) {
				player_ptr->max_mana() = static_cast<sh_int>(value);
			} else if(key.compare("hp") == 0) {
				player_ptr->hp() = static_cast<sh_int>(value);
			} else if(key.compare("max_hp") == 0) {
				player_ptr->max_hp() = static_cast<sh_int>(value);
			} else if(key.compare("move") == 0) {
				player_ptr->move() = static_cast<sh_int>(value);
			} else if(key.compare("max_move") == 0) {
				...
				player_ptr->exp() = static_cast<int>(value);
			} else if(key.compare("hitroll") == 0) {
				player_ptr->hitroll() = static_cast<sbyte>(value);
			} else if(key.compare("damroll") == 0) {
				player_ptr->damroll() = static_cast<sbyte>(value);
			} else if(key.compare("level") == 0) {
				player_ptr->level() = static_cast<byte>(value);
			} else if(key.compare("sex") == 0) {
				player_ptr->sex() = static_cast<byte>(value);
			} else if(key.compare("room") == 0) {
				player_ptr->room() = static_cast<room_rnum>(value);
			} else if(key.compare("uuid") == 0) {
				player_ptr->uuid() = static_cast<uuid_t>(value);
			}
