...
#define MENTOC_TO_STR(a){ case mw_vehicle::a: return #a; }
		switch(vehicle_type) {
				...
				MENTOC_TO_STR(FOUR_DOOR_SEDAN);
				MENTOC_TO_STR(SPORTS_CAR);
				MENTOC_TO_STR(CONVERTIBLE);
				MENTOC_TO_STR(TRUCK);
				MENTOC_TO_STR(SEMI);
				MENTOC_TO_STR(VAN);
...
#define MENTOC_TO_STR(a){ case mw_melee::a: return #a; }
		switch(melee_type) {
				...
				MENTOC_TO_STR(CROWBAR);
				MENTOC_TO_STR(CHAIN);
				MENTOC_TO_STR(WOODEN_BASEBALL_BAT);
				MENTOC_TO_STR(ALUMINUM_BASEBALL_BAT);
				MENTOC_TO_STR(HAMMER);
				MENTOC_TO_STR(SLEDGEHAMMER);
				MENTOC_TO_STR(BATON);
				MENTOC_TO_STR(HOCKEY_STICK);
				MENTOC_TO_STR(AXE);
				MENTOC_TO_STR(SHOVEL);
				MENTOC_TO_STR(PICKAXE);
				MENTOC_TO_STR(KATANA);
				MENTOC_TO_STR(MACE);
				MENTOC_TO_STR(LONGSWORD);
				MENTOC_TO_STR(NUNCHAKU);
				MENTOC_TO_STR(NAGINATA);
				MENTOC_TO_STR(DAGGER);
				MENTOC_TO_STR(SCYTHE);
				MENTOC_TO_STR(SHURIKEN);
				MENTOC_TO_STR(SPEAR);
				MENTOC_TO_STR(PIKE);
				MENTOC_TO_STR(HALBERD);
				MENTOC_TO_STR(LANCE);
				MENTOC_TO_STR(TRIDENT);
				MENTOC_TO_STR(QUARTERSTAFF);
				MENTOC_TO_STR(REBAR);
				MENTOC_TO_STR(SICKLE);
				MENTOC_TO_STR(ICE_PICK);
				MENTOC_TO_STR(CHAINSAW);
