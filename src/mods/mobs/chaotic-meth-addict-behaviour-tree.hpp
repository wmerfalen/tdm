#ifndef  __MENTOC_MODS_MOBS_chaotic_meth_addict_BEHAVIOUR_TREE_HEADER__
#define  __MENTOC_MODS_MOBS_chaotic_meth_addict_BEHAVIOUR_TREE_HEADER__
...
namespace mods::mobs::chaotic_meth_addict_behaviour_tree {
	...
	void make_chaotic_meth_addict_roam(TNode&);
	void make_chaotic_meth_addict_hostile(TNode&);
	void make_chaotic_meth_addict_wimpy(TNode&);
