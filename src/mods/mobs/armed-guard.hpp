#ifndef __MENTOC_MODS_MOBS_armed_guard_HEADER__
#define  __MENTOC_MODS_MOBS_armed_guard_HEADER__
...
namespace mods::mobs {
	...
	struct armed_guard : public smart_mob {
			...
			/**====================================================*/
			armed_guard(const uuid_t& mob_uuid,std::string_view variation);
			armed_guard() = delete;
			virtual ~armed_guard() = default;
