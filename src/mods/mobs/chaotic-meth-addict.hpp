#ifndef __MENTOC_MODS_MOBS_chaotic_meth_addict_HEADER__
#define  __MENTOC_MODS_MOBS_chaotic_meth_addict_HEADER__
...
namespace mods::mobs {
	...
	struct chaotic_meth_addict : public smart_mob {
			...
			/**====================================================*/
			chaotic_meth_addict(const uuid_t& mob_uuid,std::string_view variation);
			chaotic_meth_addict() = delete;
			virtual ~chaotic_meth_addict() = default;
