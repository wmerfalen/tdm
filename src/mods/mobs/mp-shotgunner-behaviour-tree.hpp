#ifndef  __MENTOC_MODS_MOBS_MP_SHOTGUNNER_BEHAVIOUR_TREE_HEADER__
#define  __MENTOC_MODS_MOBS_MP_SHOTGUNNER_BEHAVIOUR_TREE_HEADER__
...
#define m_debug(a) std::cerr << "[mods::mobs::mp_shotgunner_security_behaviour_tree][file:" << __FILE__ << "][line:" << __LINE__ << "]->" << a << "\n";
#else
#define m_debug(a)
#endif
...
namespace mods::mobs::mp_shotgunner_behaviour_tree {
	/**
...
#define TFAILURE TStatus::FAILURE
	...
	void make_mp_shotgunner_backup(TNode& tree) {
		...
		TNode::create_sequence({
			debug_echo_tree_name<TNode,TArgumentType,TStatus>("mp_shotgunner_backup"),
