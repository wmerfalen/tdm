#ifndef  __MENTOC_MODS_MOBS_generic_thief_BEHAVIOUR_TREE_HEADER__
#define  __MENTOC_MODS_MOBS_generic_thief_BEHAVIOUR_TREE_HEADER__
...
namespace mods::mobs::generic_thief_behaviour_tree {
	...
	void make_generic_thief_roam(TNode&);
