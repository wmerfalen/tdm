#ifndef  __MENTOC_MODS_MOBS_armed_guard_BEHAVIOUR_TREE_HEADER__
#define  __MENTOC_MODS_MOBS_armed_guard_BEHAVIOUR_TREE_HEADER__
...
namespace mods::mobs::armed_guard_behaviour_tree {
	...
	void make_armed_guard_roam(TNode&);
	void make_armed_guard_hostile(TNode&);
	void make_armed_guard_wimpy(TNode&);
