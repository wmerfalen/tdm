#ifndef  __MENTOC_MODS_MOBS_melee_combatant_BEHAVIOUR_TREE_HEADER__
#define  __MENTOC_MODS_MOBS_melee_combatant_BEHAVIOUR_TREE_HEADER__
...
namespace mods::mobs::melee_combatant_behaviour_tree {
	...
	void make_melee_combatant_roam(TNode&);
	void make_melee_combatant_hostile(TNode&);
	void make_melee_combatant_wimpy(TNode&);
