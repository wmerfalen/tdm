#ifndef __MENTOC_MODS_MOBS_melee_combatant_HEADER__
#define  __MENTOC_MODS_MOBS_melee_combatant_HEADER__
...
namespace mods::mobs {
	...
	struct melee_combatant : public smart_mob {
			...
			/**====================================================*/
			melee_combatant(const uuid_t& mob_uuid,std::string_view variation);
			melee_combatant() = delete;
			virtual ~melee_combatant() = default;
