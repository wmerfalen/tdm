...
CREATE ROLE shogun LOGIN;
CREATE DATABASE mud WITH OWNER = shogun;
\c mud
...
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (81, 124, 10, 0, 'Reverand Avenue', 'Of all the things that can be attributed to Downtown Lawton, faith surely is not one of them. From the abandoned streets and overcrowded walkways protrudes the infamous Sixth Tower Church. Worshippers gather and pay heed to the all famous deity. 
', NULL, NULL, 0, 0);
...
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (83, 126, 10, 0, 'Reverand Avenue', 'Of all the things that can be attributed to Downtown Lawton, faith surely is not one of them. From the abandoned streets and overcrowded walkways protrudes the infamous Sixth Tower Church. Worshippers gather and pay heed to the all famous deity. 
', NULL, NULL, 0, 0);
...
INSERT INTO public.room VALUES (4, 27088, 2, 0, '{grn}Directorate of Operations{/grn}', '	Three rows of terminals make up the center of this vast room, each with control
...
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (93, 136, 10, 0, 'A dimly lit cave', 'The canvas floor and walls abruptly end here. A light is hung here providing just enough illumination to notice that there is a door to the west of here that likely leads to the real reason this underground system was built.
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (94, 137, 10, 0, 'A dimly lit cave', 'The canvas floor and walls abruptly end here. A light is hung here providing just enough illumination to notice that there is a door to the west of here that likely leads to the real reason this underground system was built.
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (95, 138, 10, 0, 'A dimly lit cave', 'The canvas floor and walls abruptly end here. A light is hung here providing just enough illumination to notice that there is a door to the west of here that likely leads to the real reason this underground system was built.
', NULL, NULL, 0, 0);
INSERT INTO public.room VALUES (96, 139, 10, 0, 'Outside a fortified entrance', 'It''s not indestructible, but a normal breach charge wouldn''t cut through the thick armor that this door is fortified with. A {red}thermite{/red} charge would cut through that door, ableit very noisily.
', NULL, NULL, 0, 0);
