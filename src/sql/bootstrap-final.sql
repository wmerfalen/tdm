...
INSERT INTO public.room VALUES (4, 27088, 2, 0, '{grn}Directorate of Operations{/grn}', '	Three rows of terminals make up the center of this vast room, each with control panels and maintenance crew attending them. The northern end of the room is home to the many large monitors that keep this room constantly satiated with information. Humming machines convert and transmutate large quantities of data. Terrabytes of information are folded and manipulated-- parsed and dissected -- until the central hub and core AI modules spit out the next crucial chunk of data that could potentially save or endanger the lives of millions.', '', '', 0, 8);
